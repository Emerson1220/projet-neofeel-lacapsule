                                ...
                                <div style={ styles.single_destinations}> {/* Card expérience */}
                                    ...
                                    <div style={ styles.detail_card }>
                                        ...
                                        <div style={ styles.liste_price }>
                                            <ul style={ styles.liste_price_content, styles.lliste_price_li }>
                                                <li style={ styles.lliste_price_li }><i style={ styles.icons_fa }/> Temps</li>
                                                <li style={ styles.lliste_price_li }><i style={ styles.icons_fa }/> 4.3</li>
                                            </ul>
