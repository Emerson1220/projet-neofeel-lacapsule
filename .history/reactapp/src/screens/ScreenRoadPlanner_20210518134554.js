                            ...
                            <div style={ styles.experiences_list_area }> {/* Container -> Card expérience */}
                                <div style={ styles.single_destinations}> {/* Card expérience */}
                                    ...
                                    <div style={ styles.detail_card }>
                                        ...
                                        <h4><Link style={ styles.h3 } to="/">Activité</Link></h4>
                                        <p style={{ color: '#e06868', marginleft: '4px', marginBottom: '8px'}}><img src="images/icone-geo.png" alt="map" />Région</p>
                                        <h4 ><Link style={ styles.h3 }  to="/">Ville</Link></h4>
