            ...
            <Nav />
                <div style={ styles.container }>
                    <div style={{ textAlign:'center' }} >
                        <img style={{ width:'100%', height:'auto' }} src="images/photo-526x360.png" alt="list" />
                        <img style={{ width:'60%', height:'auto', marginTop:'1rem' }} src="images/photo-526x360.png" alt="list" />
                    </div>
