                    ...
                    <div style={ styles.row }>
                        ...
                        <div style={ styles.col_xl_9 }>                           
                            ...
                            <div style={ styles.text_align_center}> {/* Pagination */}
                                <div style={ styles.pagination, styles.display_inline}>
                                    <ul>
                                        <li><a style={ styles.pagination_ul } href="#"><i className="la la-long-arrow-left" /></a></li>
                                        <li><span style={ styles.pagination_ul }>1</span></li>
                                        <li><span style={ styles.pagination_ul }>2</span></li>
                                        <li><a style={ styles.pagination_ul } href="#">3</a></li>
                                        <li><a style={ styles.pagination_ul } href="#">4</a></li>
                                        <li><a style={ styles.pagination_ul }href="#"><i className="la la-long-arrow-right" /></a></li>
                                    </ul>                          
                                </div>
                            </div>{/* End -> Pagination */}
                        </div>
